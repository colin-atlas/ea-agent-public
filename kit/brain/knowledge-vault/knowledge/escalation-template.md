...
2. **Learn from it** — If the resolution reveals a pattern, capture in `memory/corrections.md`
3. **Prevent recurrence** — After 3 similar escalations, document the fix in `brain/knowledge/workflows.md`
